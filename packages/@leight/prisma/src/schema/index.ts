...
export const KeywordScalarFieldEnumSchema = z.enum([
    "id",
    "text"
]);
...
export const KeywordWhereInputSchema: z.ZodType<Prisma.KeywordWhereInput> = z.object({
    AND:  z.union([
        z.lazy(() => KeywordWhereInputSchema),
        z.lazy(() => KeywordWhereInputSchema).array()
    ]).optional(),
...
}).strict().refine((data) => !!data.id || !!data.text, {message: "At least one field must be provided @ KeywordWhereUniqueInput"});
...
export const KeywordScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.KeywordScalarWhereWithAggregatesInput> = z.object({
    AND:  z.union([
        z.lazy(() => KeywordScalarWhereWithAggregatesInputSchema),
        z.lazy(() => KeywordScalarWhereWithAggregatesInputSchema).array()
    ]).optional(),
...
export const KeywordCreateManyArgsSchema: z.ZodType<Prisma.KeywordCreateManyArgs> = z.object({
    data:           KeywordCreateManyInputSchema.array(),
    skipDuplicates: z.boolean().optional(),
}).strict();
