...
export class Xlsx {
    static toTabs(workbook: xlsx.WorkBook): IImportTabs[] {
    ...
    static toTranslations(workbook: xlsx.WorkBook): IImportTranslations {
    ...
    static toMeta(workbook: xlsx.WorkBook): IImportMeta {
        return {
            tabs:         this.toTabs(workbook),
            translations: this.toTranslations(workbook),
        };
    }

    static async toImport(
        {
            container,
            jobProgress,
            job,
        ...
        const meta = this.toMeta(workbook);
